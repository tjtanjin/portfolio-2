...
const MyChatBot = () => {
    ...
    const flow={
        ...
        hobby: {
            message: "I spend a vast majority of my free time exploring a bunch of projects! <a href='https://vibe-engineers.dev' target='_blank'><u>Vibe Engineers</u></a>, " + 
                "<a href='https://spaceships.tjtanjin.com/' target='_blank'><u>Spaceships</u></a>, " +
                "<a href='https://www.spigotmc.org/resources/authors/tjtanjin.724342/' target='_blank'><u>Minecraft Plugins</u></a>, and even this very " +
                "<a href='https://react-chatbotify.com' target='_blank'><u>React ChatBotify</u></a> you are interacting with, just to name a few! 😊<br/><br/>" +
        ...
        work: {
            message: "I've worked on a wide range of projects across the years. This ranges from content management systems, to REST APIs to mobile applications and platform engineering work.<br/><br/>" +
                "As I also spend a great deal of time on side projects, I have also dove into areas such as telegram bots, AI agents and server administration. In fact, keep looking and you will find some of my works on this website!<br/><br/>" +
        ...
        contact: {
            message: "I can be contacted via the following platforms 😊<br/><br/>" +
                ...
                "<li><a href='mailto:cjtanjin@gmail.com' target='_blank'><u>Email</u></a></li></ul><br/>" +
